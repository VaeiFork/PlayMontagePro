...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PMPAbilitySystemComponent)
...
UPMPAbilitySystemComponent::UPMPAbilitySystemComponent(const FObjectInitializer& ObjectInitializer)
	: Super()
	, bPendingMontageRepForMesh(false)
{
}

void UPMPAbilitySystemComponent::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
...
bool UPMPAbilitySystemComponent::GetShouldTick() const
{
...
void UPMPAbilitySystemComponent::TickComponent(float DeltaTime, ELevelTick TickType,
...
float UPMPAbilitySystemComponent::PlayMontageForMesh(UGameplayAbility* AnimatingAbility,
...
{
	UPMPGameplayAbility* InAbility = Cast<UPMPGameplayAbility>(AnimatingAbility);
...
float UPMPAbilitySystemComponent::PlayMontageSimulatedForMesh(USkeletalMeshComponent* InMesh, UAnimMontage* Montage,
...
void UPMPAbilitySystemComponent::CurrentMontageStopForMesh(USkeletalMeshComponent* InMesh,
...
void UPMPAbilitySystemComponent::StopAllCurrentMontages(float OverrideBlendOutTime)
{
...
void UPMPAbilitySystemComponent::StopMontageIfCurrentForMesh(USkeletalMeshComponent* InMesh,
...
void UPMPAbilitySystemComponent::ClearAnimatingAbilityForAllMeshes(UGameplayAbility* Ability)
{
	UPMPGameplayAbility* TagAbility = Cast<UPMPGameplayAbility>(Ability);
...
void UPMPAbilitySystemComponent::CurrentMontageJumpToSectionForMesh(USkeletalMeshComponent* InMesh,
	FName SectionName)
{
	UAnimInstance* AnimInstance = IsValid(InMesh) && InMesh->GetOwner() == AbilityActorInfo->AvatarActor ? InMesh->GetAnimInstance() : nullptr;
	const FGameplayAbilityLocalAnimMontageForMesh& AnimMontageInfo = GetLocalAnimMontageInfoForMesh(InMesh);
...
void UPMPAbilitySystemComponent::CurrentMontageSetNextSectionNameForMesh(USkeletalMeshComponent* InMesh,
...
void UPMPAbilitySystemComponent::CurrentMontageSetPlayRateForMesh(USkeletalMeshComponent* InMesh, float InPlayRate)
{
	UAnimInstance* AnimInstance = IsValid(InMesh) && InMesh->GetOwner() == AbilityActorInfo->AvatarActor ? InMesh->GetAnimInstance() : nullptr;
	const FGameplayAbilityLocalAnimMontageForMesh& AnimMontageInfo = GetLocalAnimMontageInfoForMesh(InMesh);
	if (AnimMontageInfo.LocalMontageInfo.AnimMontage && AnimInstance)
...
bool UPMPAbilitySystemComponent::IsAnimatingAbilityForAnyMesh(const UGameplayAbility* InAbility) const
{
	for (FGameplayAbilityLocalAnimMontageForMesh GameplayAbilityLocalAnimMontageForMesh : LocalAnimMontageInfoForMeshes)
	{
...
UGameplayAbility* UPMPAbilitySystemComponent::GetAnimatingAbilityFromAnyMesh()
{
...
UGameplayAbility* UPMPAbilitySystemComponent::GetAnimatingAbilityFromMesh(USkeletalMeshComponent* InMesh)
{
	const FGameplayAbilityLocalAnimMontageForMesh& AnimMontageInfo = GetLocalAnimMontageInfoForMesh(InMesh);
...
TArray<UAnimMontage*> UPMPAbilitySystemComponent::GetCurrentMontages() const
{
...
UAnimMontage* UPMPAbilitySystemComponent::GetCurrentMontageForMesh(USkeletalMeshComponent* InMesh)
{
...
int32 UPMPAbilitySystemComponent::GetCurrentMontageSectionIDForMesh(USkeletalMeshComponent* InMesh)
{
	const UAnimInstance* AnimInstance = IsValid(InMesh) && InMesh->GetOwner() == AbilityActorInfo->AvatarActor ? InMesh->GetAnimInstance() : nullptr;
...
FName UPMPAbilitySystemComponent::GetCurrentMontageSectionNameForMesh(USkeletalMeshComponent* InMesh)
{
	const UAnimInstance* AnimInstance = IsValid(InMesh) && InMesh->GetOwner() == AbilityActorInfo->AvatarActor ? InMesh->GetAnimInstance() : nullptr;
	const UAnimMontage* CurrentAnimMontage = GetCurrentMontageForMesh(InMesh);
...
float UPMPAbilitySystemComponent::GetCurrentMontageSectionLengthForMesh(USkeletalMeshComponent* InMesh)
{
	const UAnimInstance* AnimInstance = IsValid(InMesh) && InMesh->GetOwner() == AbilityActorInfo->AvatarActor ? InMesh->GetAnimInstance() : nullptr;
...
float UPMPAbilitySystemComponent::GetCurrentMontageSectionTimeLeftForMesh(USkeletalMeshComponent* InMesh)
{
	const UAnimInstance* AnimInstance = IsValid(InMesh) && InMesh->GetOwner() == AbilityActorInfo->AvatarActor ? InMesh->GetAnimInstance() : nullptr;
	UAnimMontage* CurrentAnimMontage = GetCurrentMontageForMesh(InMesh);
...
FGameplayAbilityLocalAnimMontageForMesh& UPMPAbilitySystemComponent::GetLocalAnimMontageInfoForMesh(
...
FGameplayAbilityRepAnimMontageForMesh& UPMPAbilitySystemComponent::GetGameplayAbilityRepAnimMontageForMesh(
	USkeletalMeshComponent* InMesh)
{
...
void UPMPAbilitySystemComponent::OnPredictiveMontageRejectedForMesh(USkeletalMeshComponent* InMesh,
...
void UPMPAbilitySystemComponent::AnimMontage_UpdateReplicatedDataForMesh(USkeletalMeshComponent* InMesh)
{
...
void UPMPAbilitySystemComponent::AnimMontage_UpdateReplicatedDataForMesh(
...
void UPMPAbilitySystemComponent::AnimMontage_UpdateForcedPlayFlagsForMesh(
	FGameplayAbilityRepAnimMontageForMesh& OutRepAnimMontageInfo)
{
	FGameplayAbilityLocalAnimMontageForMesh& AnimMontageInfo = GetLocalAnimMontageInfoForMesh(OutRepAnimMontageInfo.Mesh);
}

void UPMPAbilitySystemComponent::OnRep_ReplicatedAnimMontageForMesh()
{
...
bool UPMPAbilitySystemComponent::IsReadyForReplicatedMontageForMesh()
{
	/** Children may want to override this for additional checks (e.g, "has skin been applied") */
	return true;
}

void UPMPAbilitySystemComponent::ServerCurrentMontageSetNextSectionNameForMesh_Implementation(
...
bool UPMPAbilitySystemComponent::ServerCurrentMontageSetNextSectionNameForMesh_Validate(
	USkeletalMeshComponent* InMesh, UAnimMontage* ClientAnimMontage, float ClientPosition, FName SectionName,
	FName NextSectionName)
{
	return true;
...
void UPMPAbilitySystemComponent::ServerCurrentMontageJumpToSectionNameForMesh_Implementation(
...
bool UPMPAbilitySystemComponent::ServerCurrentMontageJumpToSectionNameForMesh_Validate(
	USkeletalMeshComponent* InMesh, UAnimMontage* ClientAnimMontage, FName SectionName)
{
	return true;
}

void UPMPAbilitySystemComponent::ServerCurrentMontageSetPlayRateForMesh_Implementation(
...
bool UPMPAbilitySystemComponent::ServerCurrentMontageSetPlayRateForMesh_Validate(USkeletalMeshComponent* InMesh,
