...
/**
 * Base class for anim notifies that can be used with PlayMontagePro.
 * Uses timers to ensure that notifies are triggered at the correct time.
 * Unlike Epic's UAnimNotify, which is not guaranteed to trigger.
 */
