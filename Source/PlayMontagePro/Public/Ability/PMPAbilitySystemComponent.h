 ...
 */
USTRUCT()
struct PLAYMONTAGEPRO_API FGameplayAbilityLocalAnimMontageForMesh
{
	GENERATED_BODY();
...
USTRUCT()
struct PLAYMONTAGEPRO_API FPlayTagGameplayAbilityRepAnimMontage : public FGameplayAbilityRepAnimMontage
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct PLAYMONTAGEPRO_API FGameplayAbilityRepAnimMontageForMesh
{
	GENERATED_BODY();
...
public:
	UPMPAbilitySystemComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
